...
class ImportanceWeightModule(object):
    ...
    def __init__(self, discriminator: nn.Cell, partial_classes_index: Optional[List[int]] = None):
    ...
    def get_partial_classes_weight(self, weights: mindspore.Tensor, labels: mindspore.Tensor):
        """
