...
class AutomaticUpdateDomainWeightModule(object):
    ...
    def __init__(self, num_domains: int, eta: float, device):
        self.domain_weight = ops.ones(num_domains) / num_domains
        self.eta = eta
    ...
    def update(self, sampled_domain_losses: ops.Tensor, sampled_domain_idxes):
        ...
        """
        sampled_domain_losses = sampled_domain_losses
